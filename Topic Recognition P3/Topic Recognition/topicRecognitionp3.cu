...
std::vector<int> computeSumHV(std::map<char, std::vector<int>> iM, size_t bufferSize, std::string  buffer)
{
	...
	thrust::device_vector<int> st_block22(D, 1);
	...
	thrust::device_vector<int> block8(D, 1);
	thrust::device_vector<int> block9(D, 1);
	thrust::device_vector<int> block10(D, 1);
	thrust::device_vector<int> block11(D, 1);
	thrust::device_vector<int> block12(D, 1);
	thrust::device_vector<int> block13(D, 1);
	thrust::device_vector<int> block14(D, 1);
	thrust::device_vector<int> block15(D, 1);
	thrust::device_vector<int> block16(D, 1);
	thrust::device_vector<int> block17(D, 1);
	thrust::device_vector<int> block18(D, 1);
	thrust::device_vector<int> block19(D, 1);
	thrust::device_vector<int> block20(D, 1);
	thrust::device_vector<int> block21(D, 1);
	thrust::device_vector<int> block22(D, 1);
	...
	for (size_t j = 0; j < bufferSize; j++)
		{
			...
			if (key != ' ')
			{
				...
				thrust::copy(block8.begin() + 1, block8.end(), block7.begin());
				thrust::copy(block9.begin() + 1, block9.end(), block8.begin());
				thrust::copy(block10.begin() + 1, block10.end(), block9.begin());
				thrust::copy(block11.begin() + 1, block11.end(), block10.begin());
				thrust::copy(block12.begin() + 1, block12.end(), block11.begin());
				thrust::copy(block13.begin() + 1, block13.end(), block12.begin());
				thrust::copy(block14.begin() + 1, block14.end(), block13.begin());
				thrust::copy(block15.begin() + 1, block15.end(), block14.begin());
				thrust::copy(block16.begin() + 1, block16.end(), block15.begin());
				thrust::copy(block17.begin() + 1, block17.end(), block16.begin());
				thrust::copy(block18.begin() + 1, block18.end(), block17.begin());
				thrust::copy(block19.begin() + 1, block19.end(), block18.begin());
				thrust::copy(block20.begin() + 1, block20.end(), block19.begin());
				thrust::copy(block21.begin() + 1, block21.end(), block20.begin());
				thrust::copy(block22.begin() + 1, block22.end(), block21.begin());
				...
				st_block22 = lookUpitemMemory(iM, key);

				thrust::copy(st_block22.begin(), st_block22.end(), block22.begin());

				if (j >= 7)
				{
					thrust::copy(block22.begin(), block22.end(), nGrams.begin());

					//for (size_t i = 0; i < nGrams.size(); i++) {
					//	nGrams[i] = block2[i];
					//}
					thrust::transform(nGrams.begin(), nGrams.end(), nGrams.begin(), block22.begin(), thrust::multiplies<int>());

					thrust::transform(nGrams.begin(), nGrams.end(), nGrams.begin(), block21.begin(), thrust::multiplies<int>());

					thrust::transform(nGrams.begin(), nGrams.end(), nGrams.begin(), block20.begin(), thrust::multiplies<int>());

					thrust::transform(nGrams.begin(), nGrams.end(), nGrams.begin(), block19.begin(), thrust::multiplies<int>());

					thrust::transform(nGrams.begin(), nGrams.end(), nGrams.begin(), block18.begin(), thrust::multiplies<int>());

					thrust::transform(nGrams.begin(), nGrams.end(), nGrams.begin(), block17.begin(), thrust::multiplies<int>());

					thrust::transform(nGrams.begin(), nGrams.end(), nGrams.begin(), block16.begin(), thrust::multiplies<int>());

					thrust::transform(nGrams.begin(), nGrams.end(), nGrams.begin(), block15.begin(), thrust::multiplies<int>());

					//for (size_t i = 0; i < nGrams.size(); i++) {
					//	nGrams[i] *= block1[i];
					//}
					thrust::transform(nGrams.begin(), nGrams.end(), nGrams.begin(), block14.begin(), thrust::multiplies<int>());

					thrust::transform(nGrams.begin(), nGrams.end(), nGrams.begin(), block13.begin(), thrust::multiplies<int>());

					thrust::transform(nGrams.begin(), nGrams.end(), nGrams.begin(), block12.begin(), thrust::multiplies<int>());

					thrust::transform(nGrams.begin(), nGrams.end(), nGrams.begin(), block11.begin(), thrust::multiplies<int>());

					thrust::transform(nGrams.begin(), nGrams.end(), nGrams.begin(), block10.begin(), thrust::multiplies<int>());

					thrust::transform(nGrams.begin(), nGrams.end(), nGrams.begin(), block9.begin(), thrust::multiplies<int>());

					thrust::transform(nGrams.begin(), nGrams.end(), nGrams.begin(), block8.begin(), thrust::multiplies<int>());

					thrust::transform(nGrams.begin(), nGrams.end(), nGrams.begin(), block7.begin(), thrust::multiplies<int>());
				...
				{
					thrust::fill(block0.begin(), block0.end(), 1);
					thrust::fill(block1.begin(), block1.end(), 1);
					thrust::fill(block2.begin(), block2.end(), 1);
					thrust::fill(block3.begin(), block3.end(), 1);
					thrust::fill(block4.begin(), block4.end(), 1);
					thrust::fill(block5.begin(), block5.end(), 1);
					thrust::fill(block6.begin(), block6.end(), 1);
					thrust::fill(block7.begin(), block7.end(), 1);
					thrust::fill(block8.begin(), block8.end(), 1);
					thrust::fill(block9.begin(), block9.end(), 1);
					thrust::fill(block10.begin(), block10.end(), 1);
					thrust::fill(block11.begin(), block11.end(), 1);
					thrust::fill(block12.begin(), block12.end(), 1);
					thrust::fill(block13.begin(), block13.end(), 1);
					thrust::fill(block14.begin(), block14.end(), 1);
					thrust::fill(block15.begin(), block15.end(), 1);
					thrust::fill(block16.begin(), block16.end(), 1);
					thrust::fill(block17.begin(), block17.end(), 1);
					thrust::fill(block18.begin(), block18.end(), 1);
					thrust::fill(block19.begin(), block19.end(), 1);
					thrust::fill(block20.begin(), block20.end(), 1);
					thrust::fill(block21.begin(), block21.end(), 1);
					thrust::fill(block22.begin(), block22.end(), 1);
					std::fill(st_block22.begin(), st_block22.end(), 1);
